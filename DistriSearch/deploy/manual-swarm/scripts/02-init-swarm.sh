...
echo "=============================================="
echo ""
echo -e "${BLUE}Para unir MANAGERS adicionales al cluster (HA), ejecuta en cada nodo:${NC}"
echo ""
echo -e "${YELLOW}docker swarm join --token $MANAGER_TOKEN $MANAGER_IP:2377${NC}"
echo ""
echo "=============================================="
echo ""
echo -e "${BLUE}(Opcional) Para unir WORKERS al cluster:${NC}"
...
echo ""
echo -e "${GREEN}IMPORTANTE: Para Alta Disponibilidad, todos los nodos deben ser MANAGERS${NC}"
echo ""
echo "Próximos pasos:"
echo "  1. Copiar el comando 'docker swarm join' con MANAGER_TOKEN a los otros nodos"
echo "  2. En cada nodo: ejecutar 03-join-swarm.sh <IP> <MANAGER_TOKEN>"
echo "  3. Volver aquí y ejecutar 04-deploy-infrastructure-ha.sh"
