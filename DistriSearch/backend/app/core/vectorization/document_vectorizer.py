...
from backend.app.core.vectorization.tfidf_processor import (
    TFIDFProcessor,
    FilenameTFIDFProcessor
)
from backend.app.core.vectorization.minhash_signature import (
    MinHashSignature,
    ContentMinHasher
)
...
from backend.app.core.vectorization.char_ngrams import (
    CharNGramProcessor,
    infer_category
)
